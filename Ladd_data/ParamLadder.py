...
class ParametricLadder:
    ...
    def execute(self, obj):
        ...
        h=App.ActiveDocument.getObject(label).StepHight
        L0=App.ActiveDocument.getObject(label).FloorHight
        L=App.ActiveDocument.getObject(label).RailingHight
        ...
        def ladder_c(self):
            ...
            for i in range(2):
                ...
                edge4 = Part.makeCircle(17.0, Base.Vector(0,y,0), Base.Vector(0,0,1), 0, 360)
