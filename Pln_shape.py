...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButton.setGeometry(QtCore.QRect(10, 245, 100, 23))
        self.pushButton.setObjectName("pushButton")  

        #質量計算
        self.pushButton_m = QtGui.QPushButton('massCulculation',Dialog)
        self.pushButton_m.setGeometry(QtCore.QRect(130, 245, 100, 23))
        self.pushButton_m.setObjectName("pushButton")  

        #密度
        self.lbl_gr = QtGui.QLabel('SpecificGravity',Dialog)
        self.lbl_gr.setGeometry(QtCore.QRect(130, 273, 70, 12))
        self.le_gr = QtGui.QLineEdit(Dialog)
        self.le_gr.setGeometry(QtCore.QRect(220, 270, 50, 20))
        ...
        #作業面
        self.sface = QtGui.QLabel('作業面',Dialog)
        self.sface.setGeometry(QtCore.QRect(100, 455, 50, 12))
        self.combo_sface = QtGui.QComboBox(Dialog)
        self.combo_sface.setGeometry(QtCore.QRect(150, 455, 50, 22))
    ...
    def retranslateUi(self, Dialog):
        ...
        #self.shape.setText(QtGui.QApplication.translate("Dialog", "図形", None))
