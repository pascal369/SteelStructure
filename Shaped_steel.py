...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButton.setGeometry(QtCore.QRect(200, 84, 61, 22))
        ...
        self.lineEdit_l.setGeometry(QtCore.QRect(100, 85, 71, 20))
        self.lineEdit_l.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_l.setObjectName("lineEdit_l")
        
        #checkboxソリッド
        self.checkbox = QtGui.QCheckBox(Dialog)
        self.checkbox.setGeometry(QtCore.QRect(100, 110, 61, 23))
        self.checkbox.setObjectName("checkbox")
        self.checkbox.setChecked(True)
        
        #img
        self.label_img = QtGui.QLabel(Dialog)
        self.label_img.setGeometry(QtCore.QRect(0, 135, 300, 100))
        self.label_img.setText("")
        self.label_img.setAlignment(QtCore.Qt.AlignCenter)
        L=1000
        self.lineEdit_l.setText(QtGui.QApplication.translate("Dialog", str(L), None))
        self.retranslateUi(Dialog)
        self.comboBox_type.addItems(ShpstData.type)
        self.comboBox_type.setCurrentIndex(1)
        self.comboBox_type.currentIndexChanged[int].connect(self.onType)
        self.comboBox_type.currentIndexChanged[int].connect(self.on_lst2)
        ...
        #QtCore.QObject.connect(self.pushButton_c, QtCore.SIGNAL("pressed()"), self.close)
        QtCore.QMetaObject.connectSlotsByName(Dialog)

    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QtGui.QApplication.translate("Dialog", "JIS G 3192 Shaped Steel", None))
        self.label_type.setText(QtGui.QApplication.translate("Dialog", "Shaped Steel", None))
        self.label_st.setText(QtGui.QApplication.translate("Dialog", "Standard", None))
        self.label_size.setText(QtGui.QApplication.translate("Dialog", "Size", None))
        self.label_l.setText(QtGui.QApplication.translate("Dialog", "Length[mm]", None))
        self.pushButton.setText(QtGui.QApplication.translate("Dialog", "Create", None))
        self.checkbox.setText(QtGui.QApplication.translate("Dialog", "Solid", None))
    def on_lst2(self):#管長
        pass
    ...
    def create(self):
        ...
        #label=self.comboBox_type.currentText()[3:]
        #print(label)
        ...
        if key=='00':#Angle
            ...
            obj.addProperty("App::PropertyString", "L",'Dimension').L=L
            ...
            #label='I'+dia
            #obj = App.ActiveDocument.addObject("Part::FeaturePython",label)
            #obj.addProperty("App::PropertyStringList", "dia",label).dia=dia
            b='I'
            if st=='SS':
