...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_type.setGeometry(QtCore.QRect(10, 8, 70, 12))
        self.label_type.setStyleSheet("color: black;")
        self.comboBox_type = QtGui.QComboBox(Dialog)
        self.comboBox_type.setGeometry(QtCore.QRect(100, 8, 160, 22))
        ...
        self.comboBox_st.setEditable(True)
        self.comboBox_st.lineEdit().setAlignment(QtCore.Qt.AlignCenter)  
        #言語
        #サイズ
        self.label_size = QtGui.QLabel("Size",Dialog)
        self.label_size.setGeometry(QtCore.QRect(10, 62, 50, 12))
        self.label_size.setObjectName("label_size")
        self.label_size.setStyleSheet("color: black;")
        self.comboBox_size = QtGui.QComboBox(Dialog)
        self.comboBox_size.setGeometry(QtCore.QRect(100, 62, 160, 22))
        ...
        self.label_step.setGeometry(QtCore.QRect(180, 90, 50, 16))
        self.label_step.setStyleSheet("color: black;")
        self.le_step = QtGui.QLineEdit('10',Dialog)
        self.le_step.setGeometry(QtCore.QRect(220, 90, 40, 16))
