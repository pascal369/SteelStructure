...
#高所  
        ...
        self.label_p.setGeometry(QtCore.QRect(240, 36, 71, 21))
        ...
        self.checkbox.setGeometry(QtCore.QRect(320, 36, 20, 23))
...
# 手すり位置
    ...
    def create(self):
        ...
        '''
        obj.addProperty("App::PropertyFloat", "H0",'ShapedSteel').H0=H0
        obj.addProperty("App::PropertyFloat", "B",'ShapedSteel').B=B
        obj.addProperty("App::PropertyFloat", "t1",'ShapedSteel').t1=t1
        obj.addProperty("App::PropertyFloat", "r1",'ShapedSteel').r1=r1
        obj.addProperty("App::PropertyFloat", "r2",'ShapedSteel').r2=r2
        obj.addProperty("App::PropertyFloat", "Cy",'ShapedSteel').Cy=Cy
        obj.addProperty("App::PropertyFloat", "t2",'ShapedSteel').t2=t2
        '''
