...
#形式
        ...
        self.label.setGeometry(QtCore.QRect(10, 0, 100, 22))
        self.label.setStyleSheet("color: black;")
        self.label.setAlignment(QtCore.Qt.AlignRight)   
        self.comboBox = QtGui.QComboBox(Dialog)
        self.comboBox.setGeometry(QtCore.QRect(120, 0, 81, 22))
        self.comboBox.setObjectName("comboBox")        
#形鋼
        self.label_3 = QtGui.QLabel('Shaped steel',Dialog)
        self.label_3.setGeometry(QtCore.QRect(10, 30, 100, 22))
        self.label_3.setStyleSheet("color: black;")
        self.label_3.setAlignment(QtCore.Qt.AlignRight)  
        self.comboBox_3 = QtGui.QComboBox(Dialog)
        self.comboBox_3.setGeometry(QtCore.QRect(120, 30, 81, 22))
        self.comboBox_3.setMaxVisibleItems(10)
        self.comboBox_3.setObjectName("comboBox_3")        
#形鋼サイズ
        self.label_8 = QtGui.QLabel('Size',Dialog)
        self.label_8.setGeometry(QtCore.QRect(10, 58, 100, 22))
        ...
        self.comboBox_4.setGeometry(QtCore.QRect(120, 58, 81, 22))
        self.comboBox_4.setMaxVisibleItems(10)
        self.comboBox_4.setObjectName("comboBox_4")        
#L
        self.lineEdit_L = QtGui.QLineEdit('2500',Dialog)
        self.lineEdit_L.setGeometry(QtCore.QRect(120, 85, 60, 22))
        ...
        self.label_L.setAlignment(QtCore.Qt.AlignRight)   
#L1
        self.label_L1 = QtGui.QLabel('L1[mm]',Dialog)
        self.label_L1.setGeometry(QtCore.QRect(10, 110, 100, 22))
        self.label_L1.setStyleSheet("color: black;")
        self.label_L1.setAlignment(QtCore.Qt.AlignRight)   
        self.lineEdit_L1 = QtGui.QLineEdit('70',Dialog)
        self.lineEdit_L1.setGeometry(QtCore.QRect(120, 110, 60, 22))
        self.lineEdit_L1.setObjectName("lineEdit_L1")
#H
        self.label_H = QtGui.QLabel('H[mm]',Dialog)
        self.label_H.setGeometry(QtCore.QRect(10, 135, 100, 22))
        self.label_H.setStyleSheet("color: black;")  
        self.label_H.setAlignment(QtCore.Qt.AlignRight)        
        self.lineEdit_H = QtGui.QLineEdit('2500',Dialog)
        self.lineEdit_H.setGeometry(QtCore.QRect(120, 135, 60, 22))
        self.lineEdit_H.setObjectName("lineEdit_H")
#W
        self.label_W = QtGui.QLabel('Stairs width W[mm]',Dialog)
        self.label_W.setGeometry(QtCore.QRect(10, 165, 100, 22))
        self.label_W.setStyleSheet("color: black;")
        self.label_W.setAlignment(QtCore.Qt.AlignRight)   
        self.lineEdit_W = QtGui.QLineEdit('800',Dialog)
        self.lineEdit_W.setGeometry(QtCore.QRect(120, 165, 60, 22))
...
#高所  
        ...
        self.checkbox.setGeometry(QtCore.QRect(320, 40, 20, 22))
...
#実行
        ...
        self.pushButton.setGeometry(QtCore.QRect(10, 230, 65, 22))
        self.pushButton.setObjectName("pushButton")
#mass
        self.pushButton_2 = QtGui.QPushButton('Mass culculation',Dialog)
        self.pushButton_2.setGeometry(QtCore.QRect(105, 230, 95, 22))
        self.pushButton_2.setObjectName("pushButton_2")  

# 手すり位置
        self.label_ichi = QtGui.QLabel('Handrail Position',Dialog)
        self.label_ichi.setGeometry(QtCore.QRect(10, 200, 100, 22))
        self.label_ichi.setStyleSheet("color: black;")
        self.label_ichi.setAlignment(QtCore.Qt.AlignRight)   
